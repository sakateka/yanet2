...
func fwstateModuleConfig(memCtx *C.struct_memory_context) *C.struct_fwstate_module_config {
	...
	// Allocate fwstate_config
	cfg := (*C.struct_fwstate_config)(C.memory_balloc(memCtx, C.sizeof_struct_fwstate_config))
	C.set_offset_of((*unsafe.Pointer)(unsafe.Pointer(&m.fwstate_cfg)), unsafe.Pointer(cfg))
	...
	C.set_offset_of((*unsafe.Pointer)(unsafe.Pointer(&cfg.fw4state)), unsafe.Pointer(fw4state))
	...
	C.set_offset_of((*unsafe.Pointer)(unsafe.Pointer(&cfg.fw6state)), unsafe.Pointer(fw6state))
	...
	cfg.sync_config.timeouts.tcp_syn_ack = C.uint64_t(120e9)
	cfg.sync_config.timeouts.tcp_syn = C.uint64_t(120e9)
	cfg.sync_config.timeouts.tcp_fin = C.uint64_t(120e9)
	cfg.sync_config.timeouts.tcp = C.uint64_t(120e9)
	cfg.sync_config.timeouts.udp = C.uint64_t(30e9)
	cfg.sync_config.timeouts.default_ = C.uint64_t(16e9)
